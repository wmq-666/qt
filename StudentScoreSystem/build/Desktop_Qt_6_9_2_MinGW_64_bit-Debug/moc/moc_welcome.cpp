...
void Welcome::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->switchToScore(); break;
        case 3: _t->switchToStatistics(); break;
        case 4: _t->switchToTrend(); break;
        case 5: _t->showWelcome(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Welcome::*)()>(_a, &Welcome::logoutRequested, 0))
            return;
    }
}
